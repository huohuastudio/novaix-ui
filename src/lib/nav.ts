  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "共享 IP", url: `${basePath}/shared-ips`, icon: Globe },
        { title: "私有网络", url: `${basePath}/vpcs`, icon: Shield },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "代理管理", url: `${basePath}/agents`, icon: UserCheck },
        { title: "公告管理", url: `${basePath}/announcements`, icon: Megaphone },
    ...
    },
    {
      label: "系统",
      items: [
        { title: "插件", url: `${basePath}/plugins`, icon: Blocks },
        { title: "主题", url: `${basePath}/themes`, icon: Palette },
        { title: "集成方", url: `${basePath}/integrations`, icon: Plug },
        { title: "任务管理", url: `${basePath}/tasks`, icon: ListChecks },
        { title: "告警记录", url: `${basePath}/alerts`, icon: Bell },
