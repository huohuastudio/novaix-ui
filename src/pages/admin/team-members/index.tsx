...
import { getAdminTeamMembersQueryKey } from "@/api/@tanstack/react-query.gen"
...
export default function TeamMembers() {
  ...
  const table = useDataTable({
    fetchFn: fetchData,
    queryKey: getAdminTeamMembersQueryKey(),
  ...
  return (
    <div className="space-y-6">
      <DataTable
        ...
        emptyIcon={Users}
        emptyTitle="暂无团队成员"
        emptyDescription="添加团队成员以在页面展示"
        emptyAction={<Button variant="outline" onClick={() => setCreateOpen(true)}>添加成员</Button>}
        toolbar={
