...
import { getAdminDataCentersQueryKey } from "@/api/@tanstack/react-query.gen"
...
export default function DataCenters() {
  ...
  const table = useDataTable({
    fetchFn: fetchData,
    queryKey: getAdminDataCentersQueryKey(),
  ...
  return (
    <div className="space-y-6">
      <DataTable
        ...
        emptyIcon={Building}
        emptyTitle="暂无数据中心"
        emptyDescription="添加数据中心信息以在页面展示"
        emptyAction={<Button variant="outline" onClick={() => setCreateOpen(true)}>添加数据中心</Button>}
        toolbar={
